...
# Hyperparameter
initial_state = [1.2, 1.2]  # Startzustand im Phasenraum (x0, x1)
...
# Speichern in CSV
csv_file = os.path.join(os.path.dirname(os.path.abspath(__file__)),"limit_cycle_stochastic_data_5.csv")
print(os.getcwd())
